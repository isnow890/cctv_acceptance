...
class _CctvResponseScreenState extends ConsumerState<CctvResponseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final cctv = ref.watch(
      cctvsProvider(
          HSP_TP_CD: widget.HSP_TP_CD, REQ_ID: widget.REQ_ID, SID: widget.SID),
    );
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            _renderSection(
                                title: '병원', value: data[0].get_HSP_TP_CD),
                            const Divider(
                              height: 5,
                            ),
                            _renderSection(
                                title: '요청일자',
                                value: data[0].REQ_DT.datetimeToString()),
                            const Divider(
                              height: 5,
                            ),
                            _renderSection(title: '등록번호', value: data[0].PT_NO),
                            const Divider(
                              height: 5,
                            ),
                            _renderSection(title: '환자명', value: data[0].PT_NM),
                            const Divider(
                              height: 5,
                            ),
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: _renderVerticalSection(
                                            title: '수술명',
                                            value:
                                                '하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하하',
                                            //value: e.value.OP_NM,
                                          ),
                                        ),
                                        const SizedBox(
                            ...
                            onSave: () async {
                              ...
                              try {
                                ...
                                final req = CctvUpdateReqModel(
                                    ...
                                    APBT_VETO_RSN_CD: agreeYesNo
                                        ? ''
                                        : agreeNoValue!.toString(),
                                    APBT_VETO_RSN_CNTE: val_APBT_VETO_RSN_CNTE);

                                print('go update');

                                final resp = await ref.read(
                                    updateCctvResponseProvider(body: req)
                                        .future);

                                final result = resp.isEmpty ? '제출 완료' : '에러 발생';
                                final detail =
                                    resp.isEmpty ? '감사합니다. 응답이 기록되었습니다.' : resp;
